...
using System.Threading;
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private Thread UDPServerthread = new Thread(UDPServer);
        /// <summary>
        ...
        public MainWindow()
        {
            ...
            // get the depth (display) extents 得到深度（显示）范围
        ...
        /// <summary>
        /// Handles the body frame data arriving from the sensor   处理到达的帧数
        /// </summary>
        /// <param name="sender">object sending the event</param>
        /// <param name="e">event arguments</param>
